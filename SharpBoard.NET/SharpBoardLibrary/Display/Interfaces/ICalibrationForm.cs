...
{
    public interface ICalibrationForm
    {
        WiiDevice DeviceCalibrating { get; set; }
        CalibrationPhase CalibrationState { get; set; }
        void ShowForm();
        void CloseForm();
        CalibrationPhase Calibrate(WiiDevice device, CalibrationPhase calibrationState, float x, float y);
    }
}
