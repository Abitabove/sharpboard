...
{
    public class ActionAccelerometer : ActionBase
    {
        public AccelerometerDirection Direction { get; private set; }

        public ActionAccelerometer()
        { }

        public ActionAccelerometer(XElement element)
            : base(element)
        {
            Direction = (AccelerometerDirection)Enum.Parse(typeof(AccelerometerDirection), element.Attribute("direction").Value);
        }
        ...
        public new XElement XElement
        {
            get
            {
                ...
                action.Add(new XAttribute("direction", Direction.ToString()));
                return action;
            }
        }
    }
