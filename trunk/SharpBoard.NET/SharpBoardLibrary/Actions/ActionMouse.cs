...
namespace SharpBoardLibrary
{
    public class ActionMouse : ActionBase
    {
        ...
        public ActionMouse(XElement element)
            : base(element)
        {
            Mouse = (MouseButton)Enum.Parse(typeof(MouseButton), element.Attribute("button").Value);
        }
        ...
        public new XElement XElement
        {
            get
            {
                ...
                action.Add(new XAttribute("button", Mouse.ToString()));
                return action;
            }
        }
        ...
        {
            Mouse = (MouseButton)Enum.Parse(typeof(MouseButton), param);
        }
    }
}
