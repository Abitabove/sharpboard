...
namespace SharpBoardLibrary
{
    ...
    {
        public CoordinateF[] SmoothingBuffer;
        public int SmoothingBufferIndex { get; set; }
        public int StartBufferIndex { get; set; }
        public int SmoothingAmount { get; set; }

        public bool IsEnabled {get; set;}

        public SmoothingData(int bufferSize)
        {
            SmoothingBuffer = new CoordinateF[bufferSize];
        }
    }
}
