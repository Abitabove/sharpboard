...
{
    public class X11DeviceProviderFactory : IDisplayDeviceProviderFactory
    {
        public bool IsSupported
        {
            // TODO: identify correct version
            //get { return Environment.OSVersion.VersionString.IndexOf("Unix") != -1; }
            get { return Environment.OSVersion.Platform == PlatformID.Unix; }
        }

        public IDisplayDeviceProvider Create()
        {
            return new X11DeviceProvider();
        }
